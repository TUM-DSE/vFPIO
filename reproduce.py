...
def main():
    ...
    parser.add_argument(
        ...
        "-s",
        type=str,
        default="131.159.102.20",
        help="the IP address of the RDMA server",
    )
    ...
    # default is amy's address: "131.159.102.20"
    ...
    rdma_sha256_host = benchmark(
        ...
        "build_rdma_app_sw",
        ["-t", ip_addr, "-w", "1", "--repst", "1", "-o", "sha256"],
        prefix_1=["FPGA_0_IP_ADDRESS=10.0.0.1"],
        prefix_2=["FPGA_0_IP_ADDRESS=10.0.0.2"],
        tags=[" sha256 ", "Host"],
    )
    ...
    rdma_sha256_vfpio = benchmark(
        ...
        "build_rdma_app_sw",
        ["-t", ip_addr, "-w", "1", "--repst", "1", "-o", "sha256", "-i"],
        prefix_1=["FPGA_0_IP_ADDRESS=10.0.0.1"],
        prefix_2=["FPGA_0_IP_ADDRESS=10.0.0.2"],
        repeat=1,
        tags=[" sha256 ", "vFPIO"],
    ...
    rdma_sha3_vfpio = benchmark(
        ...
        "build_rdma_app_sw",
        ["-t", ip_addr, "-w", "1", "--repst", "1", "-o", "sha3", "-i"],
        prefix_1=["FPGA_0_IP_ADDRESS=10.0.0.1"],
        prefix_2=["FPGA_0_IP_ADDRESS=10.0.0.2"],
        tags=[" sha3 ", "vFPIO"],
    )
    ...
    rdma_gzip_vfpio = benchmark(
        ...
        "build_rdma_app_sw",
        ["-t", ip_addr, "-w", "1", "--repst", "1", "-o", "gzip", "-i"],
        prefix_1=["FPGA_0_IP_ADDRESS=10.0.0.1"],
        prefix_2=["FPGA_0_IP_ADDRESS=10.0.0.2"],
        tags=[" gzip ", "vFPIO"],
    )
