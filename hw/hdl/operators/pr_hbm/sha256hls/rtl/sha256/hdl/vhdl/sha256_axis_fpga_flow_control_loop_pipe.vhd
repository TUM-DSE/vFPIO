...
entity sha256_axis_fpga_flow_control_loop_pipe is
port (
    ap_clk             : in  std_logic;
    ap_rst             : in  std_logic;
...
end entity sha256_axis_fpga_flow_control_loop_pipe;

architecture behav of sha256_axis_fpga_flow_control_loop_pipe is
begin 
